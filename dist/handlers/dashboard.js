    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, store.productsByCat(category)];
                case 2:
                    products = _a.sent();
                    res.json(products);
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, store.top5Products()];
                case 1:
                    products = _a.sent();
                    res.json(products);
                    return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, store.activeOrders(user_id)];
                case 2:
                    orders = _a.sent();
                    res.json(orders);
                    return [3 /*break*/, 4];
